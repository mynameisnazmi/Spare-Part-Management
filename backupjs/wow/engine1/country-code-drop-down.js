    ...
    customCountryCodeDropDown = function(target) {
      ...
      createAndInjectSelectedCountryCodeHTML = function() {
        ...
        if(mobileNodePlaceholder) {
          mobileNode.get('parentNode').insertBefore(selectedCountryCodeHTML, mobileNode.previous()?mobileNode.previous():mobileNode);
        } else {
          mobileNode.get('parentNode').insertBefore(selectedCountryCodeHTML, mobileNode);
        }
      };
      ...
      updateMobileNodePadding = function() {
        ...
        if(Y.one('body').getStyle('direction') === 'ltr') {
          ...
          mobileNode.set('value', mobileNode.get('value'));
          if(mobileNodePlaceholder) {
      ...
      selectCountryCode = function(e){
        ...
        countryCodeSelectNode.simulate('change');
